...
(
    ...
    global_color_a = str('dust{color:[%.1f,%.1f,%.f],scale:1}',(code%10)/10,(((code/10)%10)/10), (((code/100)%10)/10) ); //    'dust 0.1 0.9 0.1 1',
    global_color_b = str('dust{color:[%.1f,%.1f,%.1f],scale:1}',(((code/1000)%10)/10),(((code/10000)%10)/10), (((code/100000)%10)/10) );// 'dust 0.6 0.6 0.6 1'
