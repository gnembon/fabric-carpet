...
public class FeatureGenerator
{
    ...
    {
        ConfiguredStructureFeature<?, ?> configuredFeature = world.getBiome(pos).method_28405(structure.configure(null));
    ...
    public static <T extends FeatureConfig> StructureStart shouldStructureStartAt(ServerWorld world, BlockPos pos, StructureFeature<T> structure, boolean computeBox)
    {
        ...
        ConfiguredStructureFeature<?, ?> configuredFeature = biome.method_28405(structure.configure(null));
