...
{
    public static final String carpetVersion = "1.0.0-v190721";
    ...
    */
    ...
    @Rule(desc = "Optimize collisions even more", category = OPTIMIZATION)
    public static boolean optimizedCollisionsEvenMoar;
