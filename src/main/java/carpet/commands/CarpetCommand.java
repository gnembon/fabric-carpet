...
{
    private static ParsedRule<?> getRule(CommandContext<ServerCommandSource> ctx) throws CommandSyntaxException
    {
        ...
        literalargumentbuilder.executes((context)->listAllSettings(context.getSource())).
                ...
                then(literal("removeDefault").
                        ...
                        then(argument("rule", StringArgumentType.word()).
                                suggests( (c, b) -> suggestMatching(SettingsManager.getRules().stream().map(r -> r.name), b)).
                ...
                then(literal("setDefault").
                        ...
                        then(argument("rule", StringArgumentType.word()).
                                ...
                                then(argument("value", StringArgumentType.word()).
                                        suggests((c, b)-> suggestMatching(getRule(c).options, b)).
