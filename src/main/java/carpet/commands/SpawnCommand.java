...
public class SpawnCommand
{
    ...
    {
        Messenger.send(source, SpawnReporter.printMobcapsForDimension(source.getWorld().getDimension().getType().getRawId()));
        return 1;
    }
    ...
    {
        Messenger.send(source, SpawnReporter.printMobcapsForDimension(dim.getRawId()));
        return 1;
    }
