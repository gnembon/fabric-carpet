...
public class ParcetCommand
{
    public static void register(CommandDispatcher<ServerCommandSource> dispatcher)
    {
        LiteralArgumentBuilder<ServerCommandSource> literalargumentbuilder = literal("parcet").requires((player) ->
    ...
    {
        CarpetServer.settingsManager.setDefaultRule(source, rule.name, defaultValue);
    ...
    {
        CarpetServer.settingsManager.removeDefaultRule(source, rule.name);
