...
final class OptionalConverter<R> implements ValueConverter<Optional<R>>
{
     ...
     */
    @Override
    public @Nullable Optional<R> convert(Value value, @Nullable Context context)
    {
        if (value.isNull())
        {
    ...
    @Override
    public @Nullable Optional<R> checkAndConvert(Iterator<Value> valueIterator, Context context, Context.Type theLazyT)
    {
