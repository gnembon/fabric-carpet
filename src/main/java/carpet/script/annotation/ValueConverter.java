...
public interface ValueConverter<R> {
	 ...
	 *           implementations that <b>require</b> parameters from {@link #checkAndConvert(Iterator, Context, Type)} or that require multiple
	 *           parameters may decide to throw {@link UnsupportedOperationException} in this method and override {@link #checkAndConvert(Iterator, Context, Type)}
	 ...
	 *           possible instead of {@link #checkAndConvert(Iterator, Context, Type)}, since it allows its usage in generics of lists and maps.</p>
	 */
	@Nullable
	 ...
	 * passed to it via {@link #checkAndConvert(Iterator, Context, Type)}.</p>
