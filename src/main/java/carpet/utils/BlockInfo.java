...
public class BlockInfo
{
    public static Map<BlockSoundGroup, String> soundName = new HashMap<BlockSoundGroup, String>() {{
        ...
        put(BlockSoundGroup.GROUND, "gravel");
        put(BlockSoundGroup.PLANT,  "grass" );
        put(BlockSoundGroup.STONE,  "stone" );
        put(BlockSoundGroup.METAL,  "metal" );
        put(BlockSoundGroup.GLASS , "glass" );
        put(BlockSoundGroup.CLOTH , "wool"  );
    ...
    public static List<BaseComponent> blockInfo(BlockPos pos, World world)
    {
        ...
        lst.add(Messenger.s(String.format(" - Sound type: %s", soundName.get(block.getBlockSoundGroup()))));
        lst.add(Messenger.s(""));
