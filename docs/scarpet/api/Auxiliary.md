...
Available options in the scarpet app space:
  ...
  * `dimension_max_height` - Returns current dimensions' topmost Y value where one can place blocks.
  * `dimension_min_height` - Returns current dimensions' bottommost Y value where one can place blocks.
  * `dimension_center` - Returns coordinates of the center of the world with respect of the world border
  * `dimension_border_radius` - Returns radius of world border for current dimension.
  * 
