...
NOTE: This NBT storage is shared with all the scripts of the entire server and is persistent between restarts and reloads. You can also access this NBT storage with the `/data <get|modify|merge> storage <key> ...` command.
