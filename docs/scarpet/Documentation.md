# Scarpet Language Documentation

## Language Specification

[Overview](/docs/scarpet/language/Overview.md)

[Variables and Constants](/docs/scarpet/language/VariablesAndConstants.md)
...
[Overview](/docs/scarpet/api/Overview.md)

[Blocks and World Access](/docs/scarpet/api/BlocksAndWorldAccess.md)

[Block Iterations](/docs/scarpet/api/BlockIterations.md)

[Entities](/docs/scarpet/api/Entities.md)

[Inventories](/docs/scarpet/api/Inventories.md)
